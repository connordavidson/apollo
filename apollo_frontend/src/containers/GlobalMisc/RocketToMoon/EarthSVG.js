...
/*
* GOT FROM -> https://www.svgrepo.com/svg/285172/planet-earth-global
*/
function EarthSVG(props) {

  return (
    <svg id="earth" x={props.x} y={props.y} width={props.width} height={props.height} viewBox= {"0 0 " + props.viewBoxX + " " + props.viewBoxY} style={{overflow : "visible"}} >
      <circle id="blue_circle" style={{fill : "#74BAE7"}} cx="256" cy="256" r="256"/>
      <g id="earth_contents">
      ...
      <path style={{fill : "#231F20" , opacity : "0.1" , enableBackground:"new"}} d="M17.809,256c0-138.405,109.836-251.135,247.096-255.83
