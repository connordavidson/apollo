"""
Django settings for apollo_blog_backend project.
...
ROOT_URLCONF = 'apollo_blog_backend.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'apollo_blog_backend/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
REACT_APP_DIR = os.path.join(BASE_DIR , 'apollo-blog')
